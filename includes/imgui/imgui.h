...
namespace ImGui
{
	...
	IMGUI_API bool          ColorEdit3(const char* label, std::array<float, 3> &col, ImGuiColorEditFlags flags = 0);
    IMGUI_API bool          ColorEdit4(const char* label, float col[4], ImGuiColorEditFlags flags = 0);
    IMGUI_API bool          ColorEdit4(const char* label, std::array<float, 4> &col, ImGuiColorEditFlags flags = 0);
